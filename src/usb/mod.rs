...
use crate::usb_mux::UsbMuxHandle;
...
// USB constants shared by both backends.

pub(crate) const APPLE_VID: u16 = 0x05ac;
pub(crate) const PID_RANGE_LOW: u16 = 0x1290;
pub(crate) const PID_RANGE_HIGH: u16 = 0x12af;

pub(crate) const INTERFACE_CLASS: u8 = 0xff;
pub(crate) const INTERFACE_SUBCLASS: u8 = 0xfe;
pub(crate) const INTERFACE_PROTOCOL: u8 = 0x02;
